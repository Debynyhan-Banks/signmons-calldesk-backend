    ...
    >
      <div className={styles.listHeader}>
        <div>
          ...
          <p>
            Initial confirmation, reschedule, cancellation and technician
            departure intents · latest 100 tenant records · job and status
            filters apply to this loaded subset
          </p>
        </div>
        <label>
          Show
      ...
      {state === "ready" && visible.length === 0 && (
        <div className={styles.empty}>
          ...
          <p>
            ...
            Historical backfill and calendar reconciliation are not implemented.
          </p>
        </div>
      )}
