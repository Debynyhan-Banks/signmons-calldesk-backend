...
### Latest: Legacy CREATE customer-management safeguard
...
1. Review the latest APP-013 legacy CREATE customer-management safeguard on `codex/app-013-transactional-messaging` (PR #21): provisional details/all seven actions return office-review 409, fourteen unit cases and 21 database action refusals, plus desktop/mobile stale-detail removal. Audits remain clean. Separately address management soft-delete filtering and remaining legacy consumer guards before acceptance; no activation or ticket transition.
