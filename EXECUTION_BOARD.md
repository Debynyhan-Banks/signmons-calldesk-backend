...
- [ ] APP-013 Twilio-backed notification center and transactional customer messaging (`SCR-APP-021`, `SCR-APP-022`, `SCR-TECH-005`)
  - Transactional SMS templates, operator queue/history, committed appointment and technician-on-the-way triggers, canonical state identity and send-time stale-message rejection are review-ready on PR #21. Durable enqueue recovery, remaining event triggers, email, preferences, UI and acceptance remain open.
