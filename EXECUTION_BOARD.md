...
- [ ] APP-013 Twilio-backed notification center and transactional customer messaging (`SCR-APP-021`, `SCR-APP-022`, `SCR-TECH-005`)
  - Transactional SMS lifecycle/state checks, durable initial-confirmation/technician intents, read-only visibility and owner/admin exhausted-intent retry API are review-ready on PR #21. Recovery UI/acceptance, reschedule/cancellation durability, calendar reconciliation, remaining events, template/preferences controls, technician notifications, email and live acceptance remain open.
