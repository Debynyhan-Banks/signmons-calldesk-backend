...
- [ ] APP-013 Twilio-backed notification center and transactional customer messaging (`SCR-APP-021`, `SCR-APP-022`, `SCR-TECH-005`)
  - Transactional SMS lifecycle/state checks, durable initial-confirmation/technician intents and read-only history/intent visibility are review-ready on PR #21. Reschedule/cancellation durability, calendar reconciliation, recovery actions/policy, remaining events, template/preferences controls, technician notifications, email and live acceptance remain open.
