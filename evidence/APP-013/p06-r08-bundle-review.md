...
- Private file SHA-256: packet `c6a90bf4e0a65b3eefd240151e381f22af6e2433649ed1323ec862c30e76ef61`; summary `5d0502bc6e9d3e10a2b2a938dff0facb9c3db036b1c90896f2e6d123e42f46d8`; wrapper `21dceb6ac45ac52844f773ecaa7075516a63cf4326bf98c78c2de0e1869e970b`.
- Exact proposed packet: ID `ff2a3785-4418-4ef6-8a9f-0fecaf5a920d`; digest `f587d67abd357486577582bd049ad43e79a06f9dc2391e51e645daa2be38bc52`; runtime digest `ec1a01a2a45f0db78558edfd6564b3431c9604f41ae4620a43ae6d5a2ee3dc4c`; phone-policy digest `3d8d4173e37ee6ede221c0a99270aceefbbb1a6f63a9b42094cfc1cb22206f43`.
- The earlier unconsumed packet for the expired 4:30 PM preparation window is retained under the encrypted directory with an `expired-20260918T2100Z` suffix. It was never authorized and created no bundle or result.
...
- Runtime window embedded for packet validation only: `2026-09-18T23:00:00.000Z` through `2026-09-18T23:15:00.000Z` (7:00–7:15 PM Eastern). `activationAuthorized=false` and `paidVerificationAuthorized=false`; R10 approval remains mandatory.
...
4. Pending owner approval: after the earlier window expired unconsumed, the owner selected 6:30 PM Eastern for the replacement manual block. Proposed R08 prepare action ID `f477da75-feb7-44e3-a8fa-1ed0b7d53c4f`, `2026-09-18T22:30:00.000Z` through `2026-09-18T22:45:00.000Z` (6:30–6:45 PM Eastern), exact packet digest/source above. Selecting the time did not create the approval file; no authorization file exists yet.
