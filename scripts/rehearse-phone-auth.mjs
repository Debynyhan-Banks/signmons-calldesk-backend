...
const condition = 'expression=request.time >= timestamp("2026-09-12T22:36:00Z") && request.time < timestamp("2026-09-12T22:51:00Z"),title=staging-phone-one-session';
...
try {
  assert(Date.now()>=Date.parse('2026-09-12T22:36:00Z') && Date.now()<Date.parse('2026-09-12T22:40:00Z'));
  ...
  assert(Date.now()<Date.parse('2026-09-12T22:49:00Z'),'Insufficient cleanup window');
