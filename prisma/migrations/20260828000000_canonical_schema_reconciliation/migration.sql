...
-- Preserve the original December 2025 three-table prototype before creating
-- the canonical multi-tenant schema. This migration intentionally moves, and
-- never drops, legacy customer or job data. A separately reviewed migration
-- can transform these records after their production status is confirmed.
CREATE SCHEMA IF NOT EXISTS "legacy_2025";
ALTER TABLE IF EXISTS "CallLog" SET SCHEMA "legacy_2025";
ALTER TABLE IF EXISTS "Job" SET SCHEMA "legacy_2025";
ALTER TABLE IF EXISTS "Tenant" SET SCHEMA "legacy_2025";
ALTER TYPE "JobStatus" SET SCHEMA "legacy_2025";
ALTER TYPE "CallDirection" SET SCHEMA "legacy_2025";
ALTER TYPE "CallOutcome" SET SCHEMA "legacy_2025";
...
-- CreateEnum
CREATE TYPE "JobStatus" AS ENUM ('CREATED', 'OFFERED', 'ACCEPTED', 'DECLINED', 'EXPIRED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED');
...
CREATE TABLE "Job" (
    ...
    "serviceWindowStart" TIMESTAMP(3),
    "serviceWindowEnd" TIMESTAMP(3),
